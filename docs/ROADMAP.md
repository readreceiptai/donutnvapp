...
- **#64 Native projects — DONE except iOS build**: Android scaffolded/configured/**building green**; iOS scaffolded + Info.plist configured, blocked on **Xcode install** (new #63 item). Firebase config files slot in when #63(a) lands.
