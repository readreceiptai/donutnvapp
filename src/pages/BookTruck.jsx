...
const DEMO_BOOK = {
  firstName: 'Dana', lastName: 'Reed', email: 'kevin@donutnv.com', phone: '(352) 555-0177',
  eventDate: '', startTime: '', attendance: '120', zip: '34471',
  details: 'Employee appreciation afternoon for our Ocala office — looking for a fun treat for the team.',
